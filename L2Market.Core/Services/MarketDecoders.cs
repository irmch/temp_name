    ...
    public static class MarketDecoders
    {
        ...
        public static string DecodeWorldExchangeSubType(WorldExchangeItemSubType subType)
        {
            return subType switch
            {
                ...
                WorldExchangeItemSubType.ARTIFACT_B1 => "Артефакт B1",
                WorldExchangeItemSubType.ARTIFACT_C1 => "Артефакт C1",
                WorldExchangeItemSubType.ARTIFACT_D1 => "Артефакт D1",
                WorldExchangeItemSubType.ARTIFACT_A1 => "Артефакт A1",
                WorldExchangeItemSubType.ENCHANT_SCROLL => "Свиток зачарования",
                WorldExchangeItemSubType.BLESS_ENCHANT_SCROLL => "Благословенный свиток",
                WorldExchangeItemSubType.MULTI_ENCHANT_SCROLL => "Мульти свиток",
                WorldExchangeItemSubType.ANCIENT_ENCHANT_SCROLL => "Древний свиток",
                WorldExchangeItemSubType.SPIRITSHOT => "Духовный заряд",
                WorldExchangeItemSubType.SOULSHOT => "Заряд души",
                WorldExchangeItemSubType.BUFF => "Бафф",
                WorldExchangeItemSubType.VARIATION_STONE => "Камень вариации",
                WorldExchangeItemSubType.DYE => "Краска",
                WorldExchangeItemSubType.SOUL_CRYSTAL => "Кристалл души",
                WorldExchangeItemSubType.SKILLBOOK => "Книга навыков",
                WorldExchangeItemSubType.ETC_ENCHANT => "Зачарование прочее",
                WorldExchangeItemSubType.POTION_AND_ETC_SCROLL => "Зелье и свиток",
                WorldExchangeItemSubType.TICKET => "Билет",
                WorldExchangeItemSubType.CRAFT => "Крафт",
                WorldExchangeItemSubType.INC_ENCHANT_PROP => "Улучшение зачарования",
                WorldExchangeItemSubType.ADENA => "Адена",
                WorldExchangeItemSubType.ETC_SUB_TYPE => "Прочее подтип",
